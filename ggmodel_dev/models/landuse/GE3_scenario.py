...
MODEL = model_dictionnary['GE3_model']
...
def run_all_scenarios(data_dict, args_dict_1, args_dict_2):
    ...
    scenarios_results['BAU'] = run_scenario(data_dict=data_dict, MM_Ti=data_dict['MM_Ti'], MM_ASi=data_dict['MM_ASi'])
    scenarios_results['scenario_one'] = run_scenario(data_dict=data_dict, **args_dict_1)
    scenarios_results['scenario_two'] = run_scenario(data_dict=data_dict, **args_dict_2)
